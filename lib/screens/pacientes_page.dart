          ...
          child: Padding(
            ...
            child: SegmentedButton<int>(
              segments: [
                ButtonSegment<int>(
                  value: 0,
                  label: Text('Ativos (${pacientesAtivos.length})'),
                ),
                ButtonSegment<int>(
                  value: 1,
                  label: Text('Arquivados (${pacientesArquivados.length})'),
                ),
              ],
              selected: {_tabController.index},
              onSelectionChanged: (sel) => _tabController.animateTo(sel.first),
